...
export const roadmaps: Record<string, RoadmapPath> = {
  'ai-powered-developer': {
    ...
    description: 'Master AI coding tools, agent skills, and MCP to 10x your development workflow.',
    steps: [
      {
        id: 'ai-coding-tools',
        title: '1. AI Coding Tools Landscape',
        description: 'Understanding the ecosystem: Claude Code, OpenCode, Cursor, Copilot, and more. Pick the right tools for your stack.',
        concepts: [
          'Claude Code (Anthropic) — terminal-native agent',
          'OpenCode — open-source AI coding CLI',
          'Cursor — AI-first IDE with inline editing',
          ...
          'Continue.dev — open-source AI plugin for VS Code/JetBrains',
        ],
        resources: [
          { title: 'Claude Code Overview', url: 'https://docs.anthropic.com/en/docs/claude-code/overview', type: 'article' },
          { title: 'OpenCode GitHub', url: 'https://github.com/anomalyco/opencode', type: 'tool' },
          { title: 'Cursor IDE', url: 'https://cursor.com/', type: 'tool' },
          { title: 'GitHub Copilot', url: 'https://github.com/features/copilot', type: 'tool' },
          { title: 'Continue.dev', url: 'https://continue.dev/', type: 'tool' },
        ],
      },
      {
        id: 'agent-skills',
        title: '2. Agent Skills & Harnesses',
        description: 'Extend AI coding tools with reusable skills. The skills ecosystem is the new npm for AI agents.',
        concepts: [
          'What are agent skills? (.claude/skills, .opencode/)',
          'Skill formats: markdown instructions, shell scripts, MCP servers',
          'Installing community skills (git clone, npx, pip)',
          'Writing your own skills for repetitive tasks',
          'Popular skill collections: mattpocock/skills, vercel-labs/agent-skills',
          'Skill marketplaces and discovery',
          'Harness systems: ECC, Hermes Agent',
        ],
        resources: [
          { title: 'Skills Marketplace', url: '/skills', type: 'tool' },
          { title: 'Claude Code Skills Docs', url: 'https://docs.anthropic.com/en/docs/claude-code/skills', type: 'article' },
          { title: 'Matt Pocock Skills', url: 'https://github.com/mattpocock/skills', type: 'tool' },
          { title: 'Vercel Agent Skills', url: 'https://github.com/vercel-labs/agent-skills', type: 'tool' },
          { title: 'Caveman Token Saver', url: 'https://github.com/JuliusBrussee/caveman', type: 'tool' },
        ],
      },
      {
        id: 'mcp',
        title: '3. MCP — Model Context Protocol',
        description: 'Connect AI agents to external tools, databases, and APIs through the standard Model Context Protocol.',
        concepts: [
          'What is MCP? (Anthropic\'s open protocol)',
          'MCP Servers: exposing tools & resources to agents',
          'MCP Clients: IDEs and agents that consume MCP servers',
          'Popular MCP servers: filesystem, GitHub, Postgres, Brave Search',
          'Installing and configuring MCP servers in claude_desktop_config.json',
          'Building custom MCP servers with Python/TypeScript SDKs',
          'MCP vs traditional APIs — when to use each',
        ],
        resources: [
          { title: 'MCP Introduction', url: 'https://modelcontextprotocol.io/introduction', type: 'article' },
          { title: 'MCP Catalog', url: '/mcp-catalog', type: 'tool' },
          ...
          { title: 'Awesome MCP Servers', url: 'https://github.com/punkpeye/awesome-mcp-servers', type: 'article' },
        ],
      },
      {
        id: 'workflow-patterns',
        title: '4. Workflow & Productivity Patterns',
        description: 'How to integrate AI tools into your daily development workflow for maximum leverage.',
        concepts: [
          'Plan-then-execute: write specs before code',
          'AI-assisted code review and PR workflows',
          'Test-driven development with AI agents',
          'Documentation generation and maintenance',
          'Refactoring with AI: large-scale code changes',
          'Debugging with AI: stack traces, logs, root cause analysis',
          'Context management: what to include in your prompts',
          'Multi-file editing strategies across large codebases',
        ],
        resources: [
          { title: 'Planning With Files Skill', url: 'https://github.com/OthmanAdi/planning-with-files', type: 'tool' },
          { title: 'Fabric Patterns', url: 'https://github.com/danielmiessler/fabric', type: 'tool' },
          { title: 'Headroom Token Compressor', url: 'https://github.com/chopratejas/headroom', type: 'tool' },
        ],
      },
      {
        id: 'free-vs-paid',
        title: '5. Free vs Paid Resources',
        description: 'Navigate the cost landscape. You can be highly productive with free tools — here\'s what you actually need to pay for.',
        concepts: [
          'Free AI coding tools: OpenCode, Continue.dev, Codex CLI (free tier)',
          'Paid AI coding tools: Claude Code ($20/mo Pro), Cursor Pro ($20/mo), Copilot ($10/mo)',
          'Free LLM APIs: Gemini free tier, Groq, Together AI, Mistral free tier',
          'Paid LLM APIs: Anthropic ($20/mo), OpenAI ($20/mo) — per-token pricing',
          'Free model hosting: Ollama (local), Kaggle GPUs, Google Colab',
          'Paid GPU cloud: RunPod ($0.24/hr+), Lambda Labs, Vast.ai',
          'Cost optimization: token compression, caching, choosing smaller models for simple tasks',
          'The $20/mo stack: Claude Pro + Ollama local + free MCP servers',
        ],
        resources: [
          { title: 'OpenCode (Free)', url: 'https://github.com/anomalyco/opencode', type: 'tool' },
          { title: 'Ollama (Free, Local)', url: 'https://ollama.com/', type: 'tool' },
          { title: 'Groq Cloud (Free Tier)', url: 'https://console.groq.com/', type: 'tool' },
          { title: 'Gemini API (Free Tier)', url: 'https://aistudio.google.com/', type: 'tool' },
          { title: 'Continue.dev (Free)', url: 'https://continue.dev/', type: 'tool' },
          { title: 'RunPod GPU Cloud', url: 'https://runpod.io?ref=rgnqhkin', type: 'tool' },
        ],
      },
      {
        id: 'staying-updated',
        title: '6. Staying Updated',
        description: 'The AI tooling landscape moves fast. Here\'s how to stay current without getting overwhelmed.',
        concepts: [
          'GitHub Trending — filter for AI/ML topics daily',
          'Newsletters: TLDR AI, The Rundown AI, Ben\'s Bites',
          'Communities: r/ClaudeCode, r/CursorAI, AI Discord servers',
          'X/Twitter accounts to follow: @AnthropicAI, @OpenAI, AI tool builders',
          'YouTube channels: AI Explained, Matt Wolfe, Fireship (AI Code Reports)',
          'Podcasts: Latent Space, The AI Breakdown, No Priors',
          'Conference talks: AI Engineer Summit, AI DevWorld, NeurIPS',
          'Bookmark collectiveai.tools/trending — daily trending AI repos',
        ],
        resources: [
          { title: 'Trending AI Repos', url: '/trending', type: 'tool' },
          { title: 'GitHub Trending', url: 'https://github.com/trending', type: 'article' },
          { title: 'TLDR AI Newsletter', url: 'https://tldr.tech/ai', type: 'article' },
          ...
          { title: 'AI Engineer Summit Talks', url: 'https://www.ai.engineer/', type: 'video' },
        ],
      },
      {
        id: 'building-agents',
        title: '7. Building Your Own Agents',
        description: 'Go beyond using tools — build custom AI agents for your specific workflows.',
        concepts: [
          'Agent SDKs: Claude Agent SDK, OpenAI Agents SDK, Vercel AI SDK',
          'Tool calling: defining functions agents can invoke',
          'Sub-agents: delegating tasks to specialized agents',
          'Memory & persistence: maintaining state across sessions',
          'Hooks & automation: auto-format, lint, test on every change',
          'CI/CD integration: running agents in GitHub Actions',
          'Deploying agents as APIs, Slack bots, or CLI tools',
        ],
        resources: [
          { title: 'Claude Agent SDK', url: 'https://github.com/anthropics/claude-agent-sdk-typescript', type: 'tool' },
          { title: 'OpenAI Agents SDK', url: 'https://github.com/openai/openai-agents-python', type: 'tool' },
          { title: 'Vercel AI SDK', url: 'https://sdk.vercel.ai/', type: 'tool' },
          { title: 'LangGraph', url: 'https://langchain-ai.github.io/langgraph/', type: 'tool' },
          { title: 'CrewAI', url: 'https://crewai.com/', type: 'tool' },
        ],
      },
    ],
  },

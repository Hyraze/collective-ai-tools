...
const BuiltInTools: React.FC = () => {
  ...
  return (
    <>
      ...
      />
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 pb-6 sm:pb-8 pt-12">
      {/* Header */}
      <PageHeader
        title="AI Workspace"
        description="Master AI through comprehensive learning paths, career guidance, and ethical development tools. Everything runs locally in your browser."
        icon={Sparkles}
      />

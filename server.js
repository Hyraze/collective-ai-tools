...
Generate the complete workflow JSON now:`;
  ...
  try {
    ...
    console.log('Failed to parse workflow JSON, creating fallback:', error.message);
...
Generate the complete MCP Agent JSON now:`;
  ...
  try {
    ...
    console.log('Failed to parse agent JSON, creating fallback:', error.message);
...
Generate the complete analysis now:`;
  ...
  try {
    ...
    console.log('Failed to parse analysis JSON, creating fallback:', error.message);
...
Generate the complete workflow analysis now:`;
  ...
  try {
    ...
    console.log('Failed to parse workflow analysis JSON, creating fallback:', error.message);
    // Create a basic analysis structure
    analysis = {
      workflow_analysis: {
        complexity: 'intermediate',
...
Generate comprehensive insights based on the data sources and existing insights:`;
  ...
  try {
    ...
    console.log('Failed to parse data fusion analysis JSON, creating fallback:', error.message);
    // Create a basic analysis structure
    analysis = {
      insights: [
        {
...
async function handleCodeReviewer(data, config, apiKey) {
  ...
  **IMPORTANT**: Format your response as structured JSON with the following format:
  ...
  try {
    ...
    console.log('Failed to parse JSON, falling back to text parsing:', error.message);
    results = parseCodeAnalysis(analysis);
  }
...
app.listen(PORT, () => {
  ...
  console.log(`   POST /api/ai-tools (unified endpoint for all tools)`);
